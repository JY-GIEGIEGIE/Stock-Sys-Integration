...
public class ManagementApplication {
    public static void main(String[] args) throws Exception {
        ...
        ReviewService reviewService = new ReviewService(stockRepository, blacklistRepository, reviewRepository);
        ...
        server.createContext("/api/admin", new AdminHandler(authService, adminRepository, stockRepository, blacklistRepository, reviewRepository, auditRepository, centralTradingClient, accountManagementClient));
