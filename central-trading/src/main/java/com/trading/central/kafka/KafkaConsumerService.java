...
public class KafkaConsumerService {
    ...
    @KafkaListener(topics = Topics.ORDER_COMMAND, autoStartup = "${app.kafka.enabled:true}")
    ...
    @KafkaListener(topics = Topics.CANCEL_COMMAND, autoStartup = "${app.kafka.enabled:true}")
    ...
    @KafkaListener(topics = Topics.STOCK_QUERY, autoStartup = "${app.kafka.enabled:true}")
